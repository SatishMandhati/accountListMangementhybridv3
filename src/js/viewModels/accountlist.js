...
define(['accUtils', 'jquery', 'ojs/ojanimation', 'knockout', 'ojs/ojarraydataprovider', 'text!../datacontent/data.json', 'ojs/ojasyncvalidator-regexp', 'ojs/ojknockout', 'ojs/ojinputsearch', 'ojs/ojhighlighttext',
    ...
    function (accUtils, $, AnimationUtils, ko, ArrayDataProvider, employeeData, AsyncRegExpValidator) {
        function AccountListViewModel() {
